	        ...
	        <div class="copyright clearfix">
			    ...
			    <div class="container pad0">
				  	...
				  	<div class="copyright-content">
				        <p class="text-right">
				        	<?php $copyright_link = esc_url('https://www.timesbridge.com/'); ?>
				        		<?php esc_html_e('©Copyright 2018 ', 'ct-corporate');?>
		        				<a href="<?php echo esc_url($copyright_link); ?>" target="_blank">
		        					 <?php printf( esc_html__( 'Times Bridge','ct-corporate' ), 'Times Bridge' ); ?>
		        				</a>
						</p>
				  	</div>
