...
if(! function_exists('ct_corporate_scripts')){
	function ct_corporate_scripts() {
		...
		wp_enqueue_style( 'ct-corporate-css', get_stylesheet_directory_uri() . '/css/ct-corporate.css' , array(), '1.3');
        /* Style file configured here */
        wp_enqueue_style( 'ct-corporate-style', get_stylesheet_uri(), array(), '1.1.2' );
       ...
       wp_enqueue_script( 'custom-js', get_template_directory_uri() . '/js/custom.js', array( 'jquery' ), 'v1.1', true );
